...
3. Push and open a PR with `gh pr create` (squash-merge manually when ready). Do **not** touch `CHANGELOG.md` — it is generated on `main` at release time, never on a branch
4. Report PR URL
