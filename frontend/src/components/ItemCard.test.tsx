...
const MEMBERS: Map<string, Member> = new Map([
  ['user-1', { id: 'user-1', displayName: 'Ana', initial: 'A', color: '#7c3aed', photoUrl: null }],
])
...
test('shows member photo in avatar when photoUrl is set', () => {
  const membersWithPhoto = new Map([
    ['user-1', { id: 'user-1', displayName: 'Ana', initial: 'A', color: '#7c3aed', photoUrl: 'https://example.com/ana.jpg' }],
  ])
