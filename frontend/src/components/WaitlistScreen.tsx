    ...
    return (
      <div className="waitlist" role="status">
        ...
        <p className="waitlist__success-copy">
          Tu correo <strong>{email}</strong> ya está aprobado. Inicia sesión con Google para entrar.
        </p>
        
        <button className="waitlist__google-cta" onClick={() => void signIn()} style={{ marginTop: '2rem' }}>
        ...
        <button className="waitlist__cancel" onClick={() => setIsAlreadyAllowed(false)} style={{ marginTop: '1rem' }}>
          Volver
        </button>
      </div>
    )
