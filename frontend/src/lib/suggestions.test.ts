...
describe('formatFrequency', () => {
  test('< 2 days → cada día', () =>
    expect(formatFrequency(1)).toBe('cada día'));
  ...
  test('28 days → cada mes', () =>
    expect(formatFrequency(28)).toBe('cada mes'));
  test('59 days → cada mes', () =>
    expect(formatFrequency(59)).toBe('cada mes'));
